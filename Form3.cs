...
namespace Islem
{
    ...
    {
        Level3 islem1 = new Level3();
        Level3 islem2 = new Level3();
        Level3 islem3 = new Level3();
        Level3 islem4 = new Level3();
        Level3 islem5 = new Level3();
        int point = 0;
        int page = 1;
        int timer = 200;
        ...
        private void bitirbutton_Click(object sender, EventArgs e)
        {
            ...
            if (point >= 11)
            {
                if (point < 16)
                {
                    File.AppendAllText("mytextfile.txt", "LEVEL 3 SKOR :✯       Player point = " + pointlabel.Text + "\n");
                ...
                File.WriteAllText("Level" + ".txt", "Son Kalınan Bölüm 4");
