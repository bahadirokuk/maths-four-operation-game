...
namespace Islem
{
    ...
    {
        Level4 islem1 = new Level4();
        Level4 islem2 = new Level4();
        Level4 islem3 = new Level4();
        Level4 islem4 = new Level4();
        Level4 islem5 = new Level4();
        int point = 0;
        int page = 1;
        int timer = 300;
        ...
        private void bitirbutton_Click_1(object sender, EventArgs e)
        {
            ...
            if (point >= 11)
            {
                if (point < 16)
                {
                    File.AppendAllText("mytextfile.txt", "LEVEL 4 SKOR :✯        Player point = " + pointlabel.Text +"\n");
                    MessageBox.Show("✯ Tebrikler Kazandınız!", "Your point = " + pointlabel.Text, MessageBoxButtons.OK);
                }
                ...
                File.WriteAllText("Level" + ".txt", " BİTİRİLDİ BAŞTAN BAŞLANILACAK 1");
